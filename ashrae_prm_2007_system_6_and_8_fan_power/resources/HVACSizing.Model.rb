...
'
    ...
    if sql.is_initialized
      sql = sql.get
'
#Dir.pwd = C:\Users\Matt\AppData\Local\Temp\OpenStudio.qv9660\ApplyMeasureNow\UserScript\
#Dir.pwd = C:/USERS/MATT/APPDATA/LOCAL/TEMP/OPENSTUDIO.UH9660/RESOURCES/RUN/1-USERSCRIPT-0/
run_dir = "#{Dir.pwd}/SizingRun" #sql location from runSizingRun above
sql_path = OpenStudio::Path.new("#{run_dir}/energyplus/eplusout.sql")
puts sql_path.to_s.upcase
