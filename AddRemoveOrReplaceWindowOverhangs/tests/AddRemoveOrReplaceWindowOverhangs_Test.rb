...
class AddRemoveOrReplaceWindowOverhangs_Test < Test::Unit::TestCase

  
  def test_AddRemoveOrReplaceWindowOverhangs
     
    # create an instance of the measure
    measure = AddRemoveOrReplaceWindowOverhangs.new
