...
class RenameZoneHVACEquipmentAndComponents_Test < Test::Unit::TestCase

  
  def test_RenameZoneHVACEquipmentAndComponents
     
    # create an instance of the measure
    measure = RenameZoneHVACEquipmentAndComponents.new
